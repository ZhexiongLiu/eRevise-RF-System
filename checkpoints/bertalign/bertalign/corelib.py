...
def find_top_k_sents(src_vecs, tgt_vecs, k=3):
    ...
    if torch.cuda.is_available() and platform == 'linux': # GPU version
        ...
        # D = np.array([[0.99999994, 0.5758502,  0.28593463],
        #          [0.83991104, 0.5314108,  0.52726185],
        #          [0.87426853, 0.45322385, 0.43081757],
        #          [0.91912824, 0.3598091,  0.35621607],
        #          [0.63919306, 0.6302061,  0.50139797],
        #          [0.4949357,  0.4507469,  0.40593225],
        #          [0.644053,   0.4994408,  0.40415832],
        #          [1.0000002,  0.5376196,  0.48906317],
        #          [0.81437063, 0.6250943,  0.33632025]])
        # I = np.array([[0, 9, 4],
        #          [1, 3, 4],
        #          [2, 8, 7],
        #          [5, 4, 6],
