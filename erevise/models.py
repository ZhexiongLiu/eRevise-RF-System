...
client = AzureOpenAI(
        api_key="43ad07ec43fe4fc28e91070ea594fafa",
...
#         ]
    ...
    #     self.student_username = f"{self.student_firstname.lower()[:3]}{self.student_lastname.lower()[:1]}"
...
#     essay_submission = models.CharField(max_length=255)
#     essay_revision = models.CharField(max_length=255, unique=True)
#     processed = models.CharField(max_length=255)
#     submitted_time = models.DateTimeField(max_length=255)
#
#     class Meta:
#         db_table = "essay"
#         indexes = [
